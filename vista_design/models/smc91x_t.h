...
//* Generated on: Dec. 03, 2012 05:56:36 PM, (user: mbradley)
//*>
...
class smc91x_t : public smc91x_t_base {

public:
  typedef smc91x_t self_type;

public:  
  smc91x_t(sc_core::sc_module_name module_name, long simulation);
