...
//* Generated on: Dec. 03, 2012 05:56:39 PM, (user: mbradley)
//*>
...
class cpu_subsystem_t : public cpu_subsystem_t_base {

public:
  typedef cpu_subsystem_t self_type;

public:  
  cpu_subsystem_t(sc_core::sc_module_name module_name, long simulation);
