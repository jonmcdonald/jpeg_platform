                           ...
                           public JPEG_ENCODER_pv_base_parameters
{
 ...
 protected:
  ...
  virtual void cb_write_status(unsigned int newValue) = 0;
...
public:
  enum register_enum {inputaddr_idx, inputlength_idx, outputaddr_idx, outputlength_idx, status_idx, start_idx };
protected:
