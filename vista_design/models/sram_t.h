...
//* Automatically merged on: Dec. 23, 2010 02:25:49 PM, (user: sagihb)
//* Automatically merged on: Feb. 04, 2011 10:37:07 AM, (user: zamir)
//* Automatically merged on: Feb. 27, 2011 07:18:16 PM, (user: zamir)
//* Automatically merged on: Sep. 07, 2011 11:39:51 AM, (user: awinterg)
//* Automatically merged on: Feb. 22, 2012 07:01:00 PM, (user: zamir)
//* Automatically merged on: Dec. 03, 2012 05:56:43 PM, (user: mbradley)
//*>
...
class sram_t : public sram_t_base {

public:
  typedef sram_t self_type;

public:  
  sram_t(sc_core::sc_module_name module_name, long simulation);
