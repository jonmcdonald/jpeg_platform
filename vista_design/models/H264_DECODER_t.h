...
//* Automatically merged on: Dec. 03, 2012 05:56:48 PM, (user: mbradley)
//*>
...
class H264_DECODER_t : public H264_DECODER_t_base {

public:
  typedef H264_DECODER_t self_type;

public:  
  H264_DECODER_t(sc_core::sc_module_name module_name, long simulation);
