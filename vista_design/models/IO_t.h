...
//* Automatically merged on: Mar. 30, 2011 10:37:47 AM, (user: dvolinsk)
//* Automatically merged on: Sep. 07, 2011 11:39:33 AM, (user: awinterg)
//* Automatically merged on: Feb. 22, 2012 07:00:34 PM, (user: zamir)
//* Automatically merged on: Dec. 03, 2012 05:56:38 PM, (user: mbradley)
//*>
...
class IO_t : public IO_t_base {

public:
  typedef IO_t self_type;

public:  
  IO_t(sc_core::sc_module_name module_name, long simulation);
