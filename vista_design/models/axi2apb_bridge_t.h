...
//* Automatically merged on: Feb. 27, 2011 07:18:10 PM, (user: zamir)
...
class axi2apb_bridge_t : public axi2apb_bridge_t_base {

public:
  typedef axi2apb_bridge_t self_type;

public:  
  axi2apb_bridge_t(sc_core::sc_module_name module_name, long simulation);
