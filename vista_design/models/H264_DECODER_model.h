...
class H264_DECODER_pv_base;
class H264_DECODER_pv_base_mb_compatibility : public mb::mb_module {
  friend class H264_DECODER_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  H264_DECODER_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class H264_DECODER_pv_base_parameters {
 public :
  H264_DECODER_pv_base_parameters(sc_object* object);
...
class H264_DECODER_pv_base : public H264_DECODER_pv_base_mb_compatibility,
                           public H264_DECODER_pv_base_parameters
{
 private:
  typedef H264_DECODER_pv_base_mb_compatibility mb_compatibility_class;
  typedef H264_DECODER_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef H264_DECODER_pv_base self;
  SC_HAS_PROCESS(H264_DECODER_pv_base);
  H264_DECODER_pv_base(sc_core::sc_module_name& module_name);
 ...
 protected:
  ...
  virtual unsigned long long cb_read_frame_done() = 0;
 ...
 protected:
  ...
  virtual void cb_write_start(unsigned long long newValue) = 0;
  virtual void cb_write_stop(unsigned long long newValue) = 0;
  virtual void cb_write_frame_done(unsigned long long newValue) = 0;
 ...
 protected:
  ...
  virtual void cb_transport_dbg_stop(tlm::tlm_generic_payload& trans) {}
  virtual void cb_transport_dbg_frame_done(tlm::tlm_generic_payload& trans) {}
 ...
 protected:
  mb::mb_register<unsigned long long> start;
  mb::mb_register<unsigned long long> stop;
  mb::mb_register<unsigned long long> resume;
  mb::mb_register<unsigned long long> sw_reset;
  mb::mb_register<unsigned long long> interrupt;
  mb::mb_register<unsigned long long> frame_done;
  mb::mb_register<unsigned long long> frame_type;
  mb::mb_register<unsigned long long> bitstream_buffer_low;
  mb::mb_register<unsigned long long> BASE_ADDR_Y;
  mb::mb_register<unsigned long long> BASE_ADDR_U;
  mb::mb_register<unsigned long long> BASE_ADDR_V;
  mb::mb_register<unsigned long long> BASE_BITSTREAM_ADDR;
};
...
class H264_DECODER_RemoteRegisters {
...
public:
  ...
  H264_DECODER_RemoteRegisters(SOCKET& s, uint64_t baseAddress) :
    m_start(s[0], baseAddress, ((0x0) / 8), ( (0) + (((0x0) % 8) << 3)), ( (31) + (((0x0) % 8) << 3))),
    m_stop(s[0], baseAddress, ((0x4) / 8), ( (0) + (((0x4) % 8) << 3)), ( (31) + (((0x4) % 8) << 3))),
    m_resume(s[0], baseAddress, ((0x8) / 8), ( (0) + (((0x8) % 8) << 3)), ( (31) + (((0x8) % 8) << 3))),
    m_sw_reset(s[0], baseAddress, ((0xC) / 8), ( (0) + (((0xC) % 8) << 3)), ( (31) + (((0xC) % 8) << 3))),
    m_interrupt(s[0], baseAddress, ((0x10) / 8), ( (0) + (((0x10) % 8) << 3)), ( (31) + (((0x10) % 8) << 3))),
    m_frame_done(s[0], baseAddress, ((0x14) / 8), ( (0) + (((0x14) % 8) << 3)), ( (31) + (((0x14) % 8) << 3))),
    m_frame_type(s[0], baseAddress, ((0x18) / 8), ( (0) + (((0x18) % 8) << 3)), ( (31) + (((0x18) % 8) << 3))),
    m_bitstream_buffer_low(s[0], baseAddress, ((0x1C) / 8), ( (0) + (((0x1C) % 8) << 3)), ( (31) + (((0x1C) % 8) << 3))),
    m_BASE_ADDR_Y(s[0], baseAddress, ((0x20) / 8), ( (0) + (((0x20) % 8) << 3)), ( (31) + (((0x20) % 8) << 3))),
    m_BASE_ADDR_U(s[0], baseAddress, ((0x24) / 8), ( (0) + (((0x24) % 8) << 3)), ( (31) + (((0x24) % 8) << 3))),
    m_BASE_ADDR_V(s[0], baseAddress, ((0x28) / 8), ( (0) + (((0x28) % 8) << 3)), ( (31) + (((0x28) % 8) << 3))),
    m_BASE_BITSTREAM_ADDR(s[0], baseAddress, ((0x2C) / 8), ( (0) + (((0x2C) % 8) << 3)), ( (31) + (((0x2C) % 8) << 3))),
    m_dummy(0) {}
    
public:
  mb::mb_remote_register<unsigned long long, TRANS> m_start;
  mb::mb_remote_register<unsigned long long, TRANS> m_stop;
  mb::mb_remote_register<unsigned long long, TRANS> m_resume;
  mb::mb_remote_register<unsigned long long, TRANS> m_sw_reset;
  mb::mb_remote_register<unsigned long long, TRANS> m_interrupt;
  mb::mb_remote_register<unsigned long long, TRANS> m_frame_done;
  mb::mb_remote_register<unsigned long long, TRANS> m_frame_type;
  mb::mb_remote_register<unsigned long long, TRANS> m_bitstream_buffer_low;
  mb::mb_remote_register<unsigned long long, TRANS> m_BASE_ADDR_Y;
  mb::mb_remote_register<unsigned long long, TRANS> m_BASE_ADDR_U;
  mb::mb_remote_register<unsigned long long, TRANS> m_BASE_ADDR_V;
  mb::mb_remote_register<unsigned long long, TRANS> m_BASE_BITSTREAM_ADDR;
private:
  int m_dummy;
};
...
template <typename TRANS = tlm::tlm_generic_payload>
class H264_DECODER_pv_RemoteRegisters : public H264_DECODER_RemoteRegisters<TRANS> {
public:
  template <class SOCKET>
  H264_DECODER_pv_RemoteRegisters(SOCKET& s, uint64_t baseAddress)
    : H264_DECODER_RemoteRegisters<TRANS>(s, baseAddress) {
  }
};
...
class H264_DECODER_machine_arch : public MachineArch { 
    ...
    public:
        ...
        Register	frame_done;
        Register	frame_type;
        Register	bitstream_buffer_low;
        Register	BASE_ADDR_Y;
        Register	BASE_ADDR_U;
        Register	BASE_ADDR_V;
        Register	BASE_BITSTREAM_ADDR;
...
class H264_DECODER_t_base : public papoulis::SystemCBaseModel {
public:
  static H264_DECODER_t_base* create_t(const char* _name, long simulation);
public:
  H264_DECODER_t_base(sc_core::sc_module_name& module_name, long simulation);
...
public:
  virtual H264_DECODER_machine_arch* getMachineArch() const {
...
protected:
  ...
  H264_DECODER_machine_arch* m_machineArch;

protected:
  friend class H264_DECODER_model;
...
public:
  enum register_enum {start_idx, stop_idx, resume_idx, sw_reset_idx, interrupt_idx, frame_done_idx, frame_type_idx, bitstream_buffer_low_idx, BASE_ADDR_Y_idx, BASE_ADDR_U_idx, BASE_ADDR_V_idx, BASE_BITSTREAM_ADDR_idx };
protected:
  mb::mb_t_register<unsigned long long> start;
  mb::mb_t_register<unsigned long long> stop;
  mb::mb_t_register<unsigned long long> resume;
  mb::mb_t_register<unsigned long long> sw_reset;
  mb::mb_t_register<unsigned long long> interrupt;
  mb::mb_t_register<unsigned long long> frame_done;
  mb::mb_t_register<unsigned long long> frame_type;
  mb::mb_t_register<unsigned long long> bitstream_buffer_low;
  mb::mb_t_register<unsigned long long> BASE_ADDR_Y;
  mb::mb_t_register<unsigned long long> BASE_ADDR_U;
  mb::mb_t_register<unsigned long long> BASE_ADDR_V;
  mb::mb_t_register<unsigned long long> BASE_BITSTREAM_ADDR; 
...
class H264_DECODER_pv;



using namespace std;

class H264_DECODER_pvt_param_defaults {
  
public:
  H264_DECODER_pvt_param_defaults(const char* hier_name) {
  ...
  H264_DECODER_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
...
class H264_DECODER_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private H264_DECODER_pvt_param_defaults {

 public:
  typedef H264_DECODER_pvt self_type;

 public: 
  // Constructor
  H264_DECODER_pvt(sc_core::sc_module_name module_name); 
  H264_DECODER_pvt(sc_core::sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init); 
  H264_DECODER_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~H264_DECODER_pvt(); 

 
 public:
    //access the T instance
  inline H264_DECODER_t_base* getT() const {
    return m_H264_DECODER_t;
  }
  
  //access the PV instance
  inline H264_DECODER_pv* getPV() const {
    return m_H264_DECODER_pv;
  }
 ...
 private:
  ...
  //T instance
  H264_DECODER_t_base* m_H264_DECODER_t;
  
  //PV instance
  H264_DECODER_pv* m_H264_DECODER_pv;

 public:
  // External ports

  typedef esl::sc_sim::pvt_initiator_socket<64, axi_protocol_types, 1, sc_core::SC_ONE_OR_MORE_BOUND> master_type;
  master_type master;
 ...
 private:
  ...
  typedef mb::tlm20::target_socket_cb<64> master_entry_type;
 ...
 private:
  ...
  struct master_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    H264_DECODER_pvt& m_owner;
    master_nb_connector(H264_DECODER_pvt& owner) : m_owner(owner) {
    }
  ...
  struct slave_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    H264_DECODER_pvt& m_owner;
    slave_nb_connector(H264_DECODER_pvt& owner) : m_owner(owner) {
    }
