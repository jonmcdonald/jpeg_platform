...
class UART_Visualization_Linux_t : public UART_Visualization_Linux_t_base {

public:
  typedef UART_Visualization_Linux_t self_type;

public:  
  UART_Visualization_Linux_t(sc_core::sc_module_name module_name, long simulation);
